  ...
  return defineConfig({
    ...
    plugins: [
      UniPages({
        ...
        subPackages: [
          'src/pages-sub/scenic',
          'src/pages-sub/retouch',
          'src/pages-sub/selfie',
          'src/pages-sub/order',
          'src/pages-sub/me',
          'src/pages-sub/amount',
          'src/pages-sub/settings',
      ...
      AutoImport({
        imports: [
          ...
          {
            // 指定模块路径
            '@/utils/global': ['IMAGE_BASE_URL', 'gotoPage', 'getTestListApi'],
          },
        ],
