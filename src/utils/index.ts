...
export function getEnvBaseUrl() {
  ...
  const VITE_SERVER_BASEURL__WEIXIN_DEVELOP = 'https://jsonplaceholder.typicode.com'
  const VITE_SERVER_BASEURL__WEIXIN_TRIAL = 'https://jsonplaceholder.typicode.com'
  const VITE_SERVER_BASEURL__WEIXIN_RELEASE = 'https://jsonplaceholder.typicode.com'
...
export function getEnvBaseUploadUrl() {
  ...
  const VITE_UPLOAD_BASEURL__WEIXIN_DEVELOP = 'https://jsonplaceholder.typicode.com'
  const VITE_UPLOAD_BASEURL__WEIXIN_TRIAL = 'https://jsonplaceholder.typicode.com'
  const VITE_UPLOAD_BASEURL__WEIXIN_RELEASE = 'https://jsonplaceholder.typicode.com'
